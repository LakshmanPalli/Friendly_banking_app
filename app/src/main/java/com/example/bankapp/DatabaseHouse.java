...
public class DatabaseHouse extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("insert into accounts_table values(52346963,'Levi',5000.00,'livae@mail.com','XXXXXXXXXX254','IFC56389')");
        db.execSQL("insert into accounts_table values(84521987,'Deku',6000.00,'deku@mail.com','XXXXXXXXXX451','IFC56230')");
        db.execSQL("insert into accounts_table values(45123974,'Shoto',3000.00,'shoto@mail.com','XXXXXXXXXX489','IFC45612')");
        db.execSQL("insert into accounts_table values(45678921,'Asuna',9000.00,'asuna@mail.com','XXXXXXXXXX852','IFC78524')");
        db.execSQL("insert into accounts_table values(36974185,'Klien',8000.00,'Klien@mail.com','XXXXXXXXXX369','IFC89634')");
        db.execSQL("insert into accounts_table values(59135746,'Saitama',7000.00,'saitama@mail.com','XXXXXXXXXX753','IFC45127')");
        db.execSQL("insert into accounts_table values(56493278,'Mikasa',10000.00,'mikasa@mail.com','XXXXXXXXXX159','IFC45398')");
        // TABLE with 10 rows and 6 coloumns...
    }

    @Override
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) { //ignoring the change in versions as this is static
